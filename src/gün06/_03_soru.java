...
public class _03_soru extends BaseDriver {
    // 1-  https://formsmarts.com/form/yu?mode=h5 sitesini açın açın
  ...
  // her bir tıklatma vs işlemin arasına MyFunc.Bekle(2);
    ...
    public void Test1() {
        ...
        WebElement optionOnlineAdvertising=driver.findElement(By.cssSelector("[id$='_4588'] > :nth-child(4)"));//4.SEÇENEGİ SEÇ
